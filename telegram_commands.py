...
def config(message):
    from config import STRATEGY_CONFIG, PAUSE_MAX_ADX, PAUSE_MAX_ATR, SCALPING_SYMBOLS
...
TREND_MIN_ADX:
{STRATEGY_CONFIG['TRENDING']['FILTERS']['MIN_ADX']}

TREND_MIN_ATR:
{STRATEGY_CONFIG['TRENDING']['FILTERS']['MIN_ATR_PCT']}%

📉 SIDEWAYS STRATEGY

SIDEWAYS_MAX_ADX:
{STRATEGY_CONFIG['SIDEWAYS']['FILTERS']['MAX_ADX']}

SIDEWAYS_MIN_ATR:
{STRATEGY_CONFIG['SIDEWAYS']['FILTERS']['MIN_ATR_PCT']}%
...
MOMENTUM_MIN_GRADE:
{STRATEGY_CONFIG['MOMENTUM']['MIN_GRADE']}

MOMENTUM_MIN_SCORE:
{STRATEGY_CONFIG['MOMENTUM']['MIN_SCORE']}

MOMENTUM_MAX_TRADES:
{STRATEGY_CONFIG['MOMENTUM']['MAX_TRADES']}
...
Min Grade: {STRATEGY_CONFIG['MOMENTUM']['MIN_GRADE']}
Min Score: {STRATEGY_CONFIG['MOMENTUM']['MIN_SCORE']}
Max Trades: {STRATEGY_CONFIG['MOMENTUM']['MAX_TRADES']}
Auto Trade: {"ON" if main_mod.config.AUTO_TRADE else "OFF"}

⚡ SCALPING

MIN ADX: {STRATEGY_CONFIG['SCALPING']['FILTERS']['MIN_ADX']}
